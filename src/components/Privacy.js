...
function Privacy() {
    const {id} = useParams();
    const owner = 'jQuery404';
    const email = 'jquery404@gmail.com';

    return (
        <>
            <h1>PRIVACY NOTICE</h1>

            <h3>Last updated January 16, 2023</h3>

            <p>This privacy notice for <strong>{owner}</strong> (&#39;Company&#39;, &#39;we&#39;, &#39;us&#39;, or &#39;our&#39;), describes how and why we might collect, store, use, and/or share (&#39;process&#39;) your information when you use our services (&#39;Services&#39;), such as when you:</p>

            <ul>
                <li>Download and use our mobile application (<strong>{id}</strong>), or any other application of ours that links to this privacy notice</li>
                <li>Engage with us in other related ways, including any sales, marketing, or events</li>
            </ul>

            <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <u>{email}</u>.</p>

            <h2><br />
            SUMMARY OF KEY POINTS</h2>

            <p><strong>What personal information do we process? </strong>When you visit, use, or navigate our Services, we may process personal information depending on how you interact with {owner} and the Services, the choices you make, and the products and features you use. Click here to learn more.</p>
            ...
            <p>Want to learn more about what <strong>{owner}</strong> does with any information we collect? Click here to review the notice in full.</p>
            ...
            <h3><br />
            1. WHAT INFORMATION DO WE COLLECT?</h3>
            ...
            Mobile Device Access. We may request access or permission to certain features from your mobile device, including your mobile device&#39;s camera, microphone, storage, and other features. If you wish to change our access or permissions, you may do so in your device&#39;s settings.<br />
